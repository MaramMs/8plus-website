        ...
        <footer className='bg-[#1768ac] bg-[url("/images/footer-img.png")] md:py-[70px] '>
          <Wrapper>
            <Row className="md:mb-[12px]">
              ...
              <Col span={8} md={{ span: 12 }}>
                <div className="flex flex-wrap md:justify-between  justify-end md:space-y-[16px] space-y-[14px] md:m-0">
...
<div className="flex items-center gap-[4px] md:gap-[13px] text-[#fff] text-[8px] md:text-[19px] md:w-1/2 md:mt-[12px]">
                    <span className="text-[#fff] font-medium text-[8px] md:text-[19px] mr-[18px]">
                      {" "}
                      {siteData.site_phone}
                    </span>
