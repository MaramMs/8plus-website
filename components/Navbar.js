...
<Wrapper>
  <div className="flex justify-between items-center">
    ...
    <svg width="32" height="24" viewBox="0 0 32 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setMenu(!meun)} className="cursor-pointer" >
<path d="M1 1H30.3333M1 12H30.3333M1 23H13.8333" stroke="#1768AC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
